...
<head>  
  <meta charset="utf-8" />
<!--   <title>小清新音乐网站模板-777模板www.777moban.com</title> -->
  <title>首页</title>
...
<%@include file="common.jsp" %>
  <script src="<%=basePath%>sources/js/jPlayer/demo.js"></script>
  <section class="vbox">
    <header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
      <div class="navbar-header aside bg-info nav-xs">
        ...
        <a href="index.html" class="navbar-brand text-lt">
          ...
          <img src="<%=basePath%>sources/images/logo.png" alt="." class="hide">
                ...
                <div class="list-group list-group-alt">
                  <a href="#" class="media list-group-item">
                    <span class="pull-left thumb-sm">
                      <img src="<%=basePath%>sources/images/a0.png" alt="..." class="img-circle">
                    </span>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="<%=basePath%>sources/images/a0.png" alt="...">
              </span>
                  ...
                  <div class="dropdown dropup wrapper-sm clearfix">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <span class="thumb-sm avatar pull-left m-l-xs">                        
                        <img src="<%=basePath%>sources/images/a3.png" class="dker" alt="...">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p1.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p2.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p3.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p4.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p5.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p6.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p7.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                          <a href="#" class="text-ellipsis">Vivamus vel tincidunt libero</a>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p8.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p9.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p10.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p11.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <a href="#"><img src="<%=basePath%>sources/images/p12.jpg" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a2.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a3.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a8.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a9.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a1.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a6.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a7.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="<%=basePath%>sources/images/a5.png" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                              <a href="#" class="text-ellipsis">Tempered Song</a>
                              <a href="#" class="text-ellipsis text-xs text-muted">Miaow</a>
                      ...
                      <div class="list-group bg-white list-group-lg no-bg auto">                          
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<%=basePath%>sources/images/a4.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<%=basePath%>sources/images/a5.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<%=basePath%>sources/images/a6.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<%=basePath%>sources/images/a7.png" alt="...">
                          </span>
                          <span class="clear">
                        ...
                        <a href="#" class="list-group-item clearfix">
                          ...
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="<%=basePath%>sources/images/a8.png" alt="...">
                          </span>
                          <span class="clear">
                  ...
                  <ul class="list-group no-bg no-borders auto m-t-n-xxs">
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<%=basePath%>sources/images/a1.png" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<%=basePath%>sources/images/a2.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<%=basePath%>sources/images/a3.png" alt="...">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<%=basePath%>sources/images/a5.png" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<%=basePath%>sources/images/a9.png" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="<%=basePath%>sources/images/a1.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Amanda Conlan</a></div>
